...
func main() {
	...
	obj := conn.Object("pl.digital-radio", "/malina")
	...
	call := obj.Call("pl.digital-radio.Notify", 0, "c¼h", uint32(0), "", "Hallo Chaostreff!", "Ich begrüße euch herzlich zu meiner c¼h!", []string{}, map[string]dbus.Variant{}, int32(1000))
	if call.Err != nil {
		panic(call.Err)
	}
	fmt.Printf("====  CALL ====\n %s \n", call)
